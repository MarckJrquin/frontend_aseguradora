...
import { faCoins, faArrowRight, faHandsHoldingCircle } from "@fortawesome/free-solid-svg-icons";
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mb-4 md:mb-0">
                            <Link to={'/home'} >
                                <div className="flex items-center text-black dark:text-white">
                                    <FontAwesomeIcon icon={faHandsHoldingCircle} className="h-8"/>
                ...
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 ">
                            © <a href="https://pagedone.io/"> Aseguradora </a> 2024, Todos los derechos reservados.</span>
