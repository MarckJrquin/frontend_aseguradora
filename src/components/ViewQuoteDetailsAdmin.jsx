        ...
        <ModalBody>
            <div className="bg-zinc-100 dark:bg-zinc-800 rounded-lg mt-1 shadow-lg p-5">
                ...
                <div class="mb-8">
                    ...
                    <div class="text-gray-700 dark:text-zinc-200 mb-2">{quote.user.firstName} {quote.user.lastName}</div>
                    <div class="text-gray-700 dark:text-zinc-200 mb-2">@{quote.user.username}</div>
                </div>
