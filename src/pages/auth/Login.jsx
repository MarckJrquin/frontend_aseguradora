    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (signin.fulfilled.match(resultAction)) {
                ...
                const errorMsg = resultAction.payload || 'Usuario o contraseña incorrectos';
            ...
            <div className="flex h-screen">
                <div className="hidden lg:flex items-center justify-center flex-1 bg-white dark:bg-gray-900">
                    <div className="h-full w-full">
                        <img className="object-cover object-center h-full w-full" src="https://images.pexels.com/photos/1051071/pexels-photo-1051071.jpeg" alt="Imagen" />
                    </div>
                </div>
